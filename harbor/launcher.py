...
class Launcher(tk.Tk):
    def __init__(self):
        ...
        self.pseudo = tk.Entry(self, font=("Arial", 14), fg=TEXT, bg="#0A1B24",
    ...
    def _draw(self):
        ...
        self._logo_y = 96
        c.create_text(W // 2, 176, text="RAFT × SEA OF THIEVES — par Studio Echelon",
                      fill=MUTED, font=("Arial", 10))

        # nouveautés
        card = self._rounded("news", 480, 108, "#0E1B22", "#0A141A", radius=14, border="#1E3A30")
